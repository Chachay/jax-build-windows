...
Copy-Item -Path "d:\a\cudnn\cudnn-windows-x86_64-8.5.0.96_cuda11-archive\*" -Destination "$($Env:ProgramFiles)\NVIDIA GPU Computing Toolkit\CUDA\v11.7" -Recurse -Verbose
